    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <nav className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-5 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/auth/signin"
            className="rounded-full border border-white/10 bg-white/6 px-4 py-2 text-xs font-medium text-zinc-300 hover:bg-white/10"
          >
            Sign in
          </Link>
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-5 pb-20 sm:px-8">
        <div className="glass-panel-strong rounded-[2rem] p-8 text-center sm:p-12">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <Link
              href="/"
              className="rounded-xl border border-white/10 bg-white/6 px-8 py-3 text-sm font-medium text-zinc-300 hover:bg-white/10 transition"
            >
              Use without account
            </Link>
            <a
